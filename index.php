...
<html lang="en">
  ...
  <thead>
    <tr>
      ...
      <th class="text-light" scope="col">KODE POS</th>
      <th class="text-light" scope="col">alamat</th>
  ...
  <?php 
		...
		while($d = mysqli_fetch_array($data)){
			...
			<tr>
				...
				<td class="text-light"><?php echo $d['nama']; ?></td>
				<td class="text-light"><?php echo $d['kodepos']; ?></td>
				<td class="text-light"><?php echo $d['alamat']; ?></td>
				<td>
      ...
      <div class="modal-header"><button onclick='change();'  value='show' id='btn1' type="button" class="btn btn-primary">TAMBAH</button></a>
  </div>
<br>
...
<form method="post" action="tambah_aksi.php">
		<table>
			...
			<tr>
				<td class="text-light">kodepos</td>
